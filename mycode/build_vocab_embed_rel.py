...
if __name__ == "__main__":
	...
	pos_dataset_file = "classifier3/subj_sents-a1.txt"
	neg_dataset_file = "classifier3/not_subj_sents-a1.txt"
	...
	for vector in vectors:
		build_vocab_and_embeddings(sentences_all, vector,'class3subj-a1')