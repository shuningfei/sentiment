...
if __name__ == "__main__":
	...
	for prod in products:
		...
		sentences_prod = load_data(prod_dataset_file)
		sentences_padded_prod = pad_sentences(sentences_prod, 185)
		sentences_all += sentences_padded_prod

	vectors = ['w2v', 'random']

	for vector in vectors:
		build_vocab_and_embeddings(sentences_all, vector,'class4-a1')