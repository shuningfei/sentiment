...
CNN-tuned: When word vectors are tuned, parameters to learn are elements of the filter matrices, bias term and the embedding matrix. tf.Variable means learned parameters.
